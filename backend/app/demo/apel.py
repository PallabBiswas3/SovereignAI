...
class ApelDemoService:
    ...
    def generate(self) -> list[dict[str, Any]]:
        ...
        write("engineering/specifications/Compressor-201_Technical_Requirements.md", "# Compressor-201 Technical Requirements\n\nCapacity: 4800 Nm3/h minimum. Discharge pressure: 7.5 bar. Guaranteed specific power: at most 0.112 kWh/Nm3. Noise: at most 85 dBA at 1 m. Materials certificate EN 10204 3.1 required.", "engineering", "CONFIDENTIAL", "Compressor-201", "HAS_REQUIREMENT")
        write("procurement/vendors/Vendor_Atlas_Proposal.md", "# Atlas Proposal for Compressor-201\n\nCapacity 4900 Nm3/h; pressure 7.5 bar; specific power 0.109 kWh/Nm3; noise 84 dBA; EN 10204 3.1 certificates included. Commercial validity 60 days.", "procurement", "CONFIDENTIAL", "Compressor-201", "HAS_PROPOSAL")
        write("procurement/vendors/Vendor_Boreal_Proposal.md", "# Boreal Proposal for Compressor-201\n\nCapacity 5000 Nm3/h; pressure 7.5 bar; specific power not stated; noise 83 dBA; material certificate statement unsupported by attachment.", "procurement", "CONFIDENTIAL", "Compressor-201", "HAS_PROPOSAL")
        write("procurement/vendors/Vendor_Cascade_Proposal.md", "# Cascade Proposal for Compressor-201\n\nCapacity 4700 Nm3/h; pressure 7.4 bar; specific power 0.111 kWh/Nm3; noise guarantee not provided; EN 10204 3.1 certificates included.", "procurement", "CONFIDENTIAL", "Compressor-201", "HAS_PROPOSAL")
